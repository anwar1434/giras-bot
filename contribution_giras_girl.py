...
WORKSHEET_NAME = os.getenv("WORKSHEET_NAME", "مشاركات الاناث")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("حيا الله أختنا الحبيبة ! ما هو اسمك الكامل؟")
